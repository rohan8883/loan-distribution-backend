export const complaintRejection = ({
    title,
    complaintNo,
    citizenName,
    ulbName,
...
<body>
    <div class="email-wrapper">
        <div class="invoice-box">
            ...
            <div style="font-weight: bold;color: red; font-size: 18px; padding-left: 4px;"># Complaint Rejected</div>
            ...
            <p style="color: gray;">Your complaint having complaint no: ${complaintNo} has been rejected. You can track you details from the greivance panel with your complaint no.</p>
