...
<body>
    <div class="email-wrapper">
        <div class="invoice-box">
            ...
            <div style="font-weight: bold;color: red; font-size: 18px; padding-left: 4px;"># Complaint Closed</div>
            <p style="color: gray;font-size: 16px">Complaint No. : ${complaintNo}</p>

            <p style="margin-top: 20px; color: #2D7CE2; font-weight: 600;">Hi, ${citizenName}</p>
            <p style="color: gray;">Your complaint having complaint no: ${complaintNo} has been closed by you. You can track you details from the greivance panel with your complaint no.</p>
